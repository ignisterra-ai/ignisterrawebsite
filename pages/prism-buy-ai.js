      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center relative">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/4 -left-40 w-80 h-80 bg-red-300/40 rounded-full filter blur-[100px]"></div>
            <div className="absolute bottom-1/4 -right-40 w-80 h-80 bg-pink-400/40 rounded-full filter blur-[100px]"></div>
